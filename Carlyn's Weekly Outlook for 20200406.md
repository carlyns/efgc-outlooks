## Carlyn's Weekly Outlook for 20200406
### Routine Tasks
* Gift Entry
...
22. Continued to test draft objects and connections to better handle Correspondence records, Tributes and Notifications from donations.
23. 
24. Continued to filter through and remove obsolete reports.
25. “Continued” to communicate with SF support regarding email alert for Contact Solicitation value when “deceased” checked on Contact. >> to another week.
...
- - - -
### Quarterly Goals
*By midQ3 (may15):* 4th round of Client Services solutions complete, Gifts Documentation complete, Brainstorm Donation-Finance flow improvements, Increased support for Finance/Ops
