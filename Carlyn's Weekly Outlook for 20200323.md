## Carlyn's Weekly Outlook for 20200323
### Routine Tasks
* Gift Entry
...
4. Imported night-of gala donations.
5. Researched adding Salesforce licenses one by one.
...
23. Designed and drafted new SF Process to create Correspondence records from donations.
...
36. Troubleshooted a Create New Donation error? >> to another week
37. again? Clarified which reports existed already for VP of Client Services and assisted some staff members with using filters.
38. Continued basic UI improvements on Client Services objects: XXX Object.  Reviewing default and required fields, scoping the cleanup necessary, preparing cleanup sheets, hiding/reordering sections and fields, clarifying tasks with case managers and other staff.  >> to another week
...
41. 
42. iPad login redirect issue.  Reopen this case with SF Support to see if i can find a competent developer.  To see if there is actual javascript code that can work around the login redirect screen  >> to another week.
43. Reviewed concepts with case management team after observing incoming data patterns.  >> to another week
44. Observed a client intake conducted by case manager. >> to another week
