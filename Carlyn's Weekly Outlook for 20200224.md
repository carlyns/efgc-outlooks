## Carlyn's Weekly Outlook for 20200224
### Routine Tasks
* Gift Entry
...
16. Spent 30 min explaining which report TH needed (she should know) for her task.  Waiting for her to bookmark it.  Waiting for her to know how to open it.  Waiting for her to refresh it.  Explaining that a report specific to the employment program task is a special request custom to the task.  
17. Spent another 10 min having TH trying to act like we implemented something without her - whether case notes should go under a CaseRecord or in Interactions if they didn’t have current consent.  If she knew the definition of a CaseNote, she would know that.  If she knew the purpose of creating the Interactions, she would know that.  Those are both in the manual.  Also, I created Interactions on her approval to satisfy a certain need they had for recording notes on a Contact before they had a CaseRecord - she should know what the purpose of that is.  If she didn’t create any Operational change for it, it’s never just been implemented independently in SF.  
...
36. 
37. for consistency when creating mailing lists.  revised values to show Do Not Contact / Solicit distinction.  Attempted to build process builder to replicate solicitation values from Contact to Accounts (but realized same issue with batch edit)  Need to research if this is a native SF function, possibly rebuild function.  >> to another week
38. iPad login redirect issue.  Reopen this case with SF Support to see if i can find a competent developer.  To see if there is actual javascript code that can work around the login redirect screen  >> to another week.
39. Reviewed concepts with case management team after observing incoming data patterns.  >> to another week
40. Observed a client intake conducted by case manager. >> to another week
