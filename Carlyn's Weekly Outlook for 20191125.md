## Carlyn's Weekly Outlook for 20191125
### Routine Tasks
* Gift Entry
...
2. Requested help from Preferred for SQL Penelope data.  
...
6. Created more lite versions of internal team reports:  satisfaction questions, etc.  Explained the importance of these reports to VP of Client Services.  
...
8. Continued to build out redesigned Status-Service structure.  Designed and built Label custom field on Activity to replace purpose of Service Files.  
9. Consolidated existing Service Files to two, which involved preparing data import sheets for the following changes: Used existing Service Files to label connected Activities.  Setup mapping ensure Activities were moved to correct new Service File.  Identified contacts that immediately needed new Service Files.  Created two standard Service Files for all Case Records.  Mapped event Members from old to new service files.  Mapped event Attendees from old to new service files.  
10. Monitored for issues after rollout of new Service File structure and Activity Label. 
