## Carlyn's Weekly Outlook for 20200608
### Routine Tasks
* Gift Entry
...
6. 
7. Streamlined classification fields for affiliated events gifts?  Cleaned and moved existing data to new setup.    >> to another week
8. Fixed disconnect between anonymous donation and anonymous label on the contact/account record by creating automation.  ?? >> to another week
9. 
10. Considered adding more Salesforce licenses.  any more comments on this??  >> to another week
11. Being the authority on explaining the DHS/DFI Quarterly reports to Stacy as ordered by BJ that “we’re” walking her through it.  >> to another week
...
20. Prioritized project: Continued steps to eliminate Case Notes.  Checking existing data.  Confirming how to handle historic data with Stacy.  Designing where to move Direct Referrals over to Activities and how to move that data.  
21. Ask SF Support where to control assignment of staff members on activities to start investigating how to map same unit activity onto all activities that are auto-generated through the Client Staffings meeting events.  
