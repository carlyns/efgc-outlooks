## Carlyn's Weekly Outlook for 20200803
### Routine Tasks
* Gift Entry
...
6. Discussed yearly audit with supervisor.  
...
21. Troubleshooted lookup field and validation rule on Public Events’ service group field.  
22. Gradual cleanup of case records with multiple service files incorrectly connected to other contacts from old system.  >> to another week
...
24. Continued to test draft objects and connections to better handle Correspondence records, Tributes and Notifications from donations.  >> to another week, but doesn’t seem to be worth doing… maybe only to track sympathy cards that go out. 
25. Continued to filter through and remove obsolete reports. >> to another week
26. Continued to delete obsolete fields from Contact object, locating hard connections where necessary. >> to another week
27. Added [FIELDS] to [BACKGROUND] Form and all respective layouts (FT, paper, SF).  Reformatted layouts with 2 deleted fields and other revisions.  Waited for an overnight refresh of configuration on FormTitan to establish mapping.  
28. Started on Attendance-Activity disconnect in UAT ??? 
29. Started on Participation Lite in UAT ???
30. Discussions about Activities via Programs dept (Leia) and creating Case Records.  ????
