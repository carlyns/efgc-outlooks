## Carlyn's Weekly Outlook for 20200504
### Routine Tasks
* Gift Entry
...
4. Considered adding more Salesforce licenses.  any more comments on this??  >> to another week  
5. Addressed one error message when adding attendance, but error message couldn’t be recreated.  
6. Being the authority on explaining the DHS/DFI Quarterly reports to Stacy as ordered by BJ that “we’re” walking her through it.  >> to another week
...
24. Continued to design and test programming using Process Builder and Flow to sync Activities with Case Notes to remove current repeat step for staff.
...
30. Continued to refine draft of Business Development structure in sandbox to get it ready for testing.  Troubleshooted record type default selection with SF support.  Corrected visible information on account hierarchy view.  >> to another week.
